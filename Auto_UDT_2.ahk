...
Step_10_File_Selection(){
	...
	Sleep, 100
	Send, {BACKSPACE}
	Send, D:\localhome\ECU-flash\Documents\AICP_1_191_1_20_1_5_DAG_GABS_CEEA_1.3_Trunk-INC3.3-1903_IF2\Application\NorthAmerica_12V\Output
	Send, {ENTER}
	Sleep, 100
...
Step_30(){
	...
	Sleep, 100	
	Send, {BACKSPACE}
	Send, D:\localhome\ECU-flash\Documents\Reflash - Production Parameters
	Send, {ENTER}	
}
